...
public class Scene4 extends Scene {
	...
	public void init(Window window) {
		...
		startColor1 = new Vec4(.980f, .969f, .718f, 1);
		endColor1 = new Vec4(.408f, .702f, .525f, 1);
		startColor2 = new Vec4(.772f, .208f, .055f, 1f);
		endColor2 = new Vec4(.262f, .164f, .169f, 1f);
		...
		glUniform1f(shaders.getUniformLocation("alpha"),0);
		alpha = 1;
