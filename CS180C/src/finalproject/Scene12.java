...
public class Scene12 extends Scene {
	...
	private double lastRuntime, lastRuntime2;
	...
	public Scene12(float startTime) {
		super(startTime);
	...
	public void init(Window window) {
		...
		lastRuntime2 = window.getRuntime();
	...
	public void renderFrame(Window window, float musicTime) {
		...
		if(currentRuntime - lastRuntime2 > 1.65 ) {
			lastRuntime2 = currentRuntime;
			s.rotate(Math.PI/3);
		}
